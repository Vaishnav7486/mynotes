...
class NotesService {
  ...
  Stream<List<DatabaseNote>> get allNotes =>
      _notesStreamController.stream.filter((note) {
        ...
        if (currentUser != null) {
          ...
          throw UserShouldBeSatBeforeReadingAllNotes();
        }
      });
  ...
  Future<int> deleteAllNotes() async {
    await _ensureDbIsOpen();
    final db = _getDatabaseOrThrow();
    final numberOfDeletios = await db.delete(noteTable);
    _notes = [];
    _notesStreamController.add(_notes);
    return numberOfDeletios;
  }
...
class DatabaseNote {
  ...
  @override
  String toString() =>
      'Note, ID = $id, userId = $userId, isSyncedwithcloudis = $isSyncedWithCloud , text= $text';
